...
//generates private key, public key and public key password
#[wasm_bindgen]
...
//encrypts aes key with given public key
#[wasm_bindgen]
...
//decrypts aes key with given private key
#[wasm_bindgen]
...
pub fn encrypt_file(file_data: Vec<u8>) -> encrypt_args{
    ...
    let nonce = Nonce::from_slice(rnd_nonce.as_bytes());
